...
export default () => {
  ...
  const handilSearch = () => {
    navigate('/search'); // Use navigate function to redirect
  };
  ...
  return (
    <header className='flex justify-between'>
      ...
      <div className='flex border border-gray-300 rounded-full px-4 py-2 gap-4 shadow-md shadow-gray-300'>
        <div>Any Where</div>
        <div className='border-l border-gray-300 '></div>
        <div>Any week</div>
        <div className='border-l border-gray-300 '></div>
        <div>Add Guste</div>
        <button className='bg-primary p-1 text-white rounded-full' onClick={handilSearch}>
